...
@section('content')
    <div class="card">
        ...
        {!! Form::open(['route'=>'admin.sliders.store', 'method'=>'post','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 form-group">
                    {!! Form::label('name','Name') !!}
                    {!! Form::text('name','',['class'=>$errors->has('name')?'form-control is-invalid':'form-control','placeholder'=>'Name']) !!}
                </div>
                <div class="col-md-12 form-group">
                    {!! Form::label('Title','Title') !!}
                    {!! Form::text('title','',['class'=>$errors->has('title') ? 'form-control is-invalid':'form-control','id' => 'title','placeholder'=>'Title']) !!}
                </div>
                <div class="col-md-12 form-group">
                    {!! Form::label('Description','Description') !!}
                    {!! Form::textarea('description','',['class'=>$errors->has('description') ? 'form-control is-invalid':'form-control','rows'=>'5','id' => 'testimonial','placeholder'=>'Description']) !!}
                </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    {!! Form::number('ordering','',['class'=>$errors->has('ordering')?'form-control is-invalid':'form-control required']) !!}
                </div>
                <div class="col-md-12">
