...
class SliderDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $actionBtn = '<a href="/admin/sliders/'.Encryption::encodeId($data->id).'" class="btn btn-sm btn-info" title="View"><i class="fa fa-eye"></i> View</a> ';
                $actionBtn .= '<a href="/admin/sliders/' . Encryption::encodeId($data->id) . '/edit/" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i> Edit</a> ';
                $actionBtn .= '<a href="/admin/sliders/' . Encryption::encodeId($data->id) . '/delete/" class="btn btn-sm btn-danger action-delete" title="Delete"><i class="fa fa-trash"></i> Delete</a> ';
                return $actionBtn;
            })
            ->editColumn('image',function ($data){
                $url = url("/uploads/sliders/".$data->image);
    ...
    protected function filename(){
        return 'sliders_' . date('Y_m_d_H_i_s');
    }
}
